...
class MyModelTrainerRigL(ModelTrainer):
    ...
    def train(self, train_data,  device,  args, round, masks):
        ...
        if args.client_optimizer == "sgd":
            ...
            pruner = RigLScheduler(model, optimizer, dense_allocation=args.dense_ratio, alpha=args.partition_alpha, delta=delta_temp, static_topo=True, T_end=T_end_temp, ignore_linear_layers=False, grad_accumulation_n=1)
            # pruner = RigLScheduler(model, optimizer, dense_allocation=0.3)
